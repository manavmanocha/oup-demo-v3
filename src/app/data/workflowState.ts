...
const WORKFLOW_LABELS: Record<WorkflowState, string> = {
  ...
  IN_DIFFICULTY_ESTIMATION: 'In Difficulty Prediction',
  PENDING_DP_REVIEW: 'Difficulty Prediction Review',
  DP_APPROVED: 'Live',
  DP_REJECTED: 'Difficulty Prediction Review',
  RECOMMENDED_FOR_SEEDING: 'Difficulty Prediction Review',
  SEEDED: 'Seeded',
};
